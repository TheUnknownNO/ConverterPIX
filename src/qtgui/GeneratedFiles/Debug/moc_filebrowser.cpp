...
QT_MOC_LITERAL(1, 12, 26), // "directoryViewDoubleClicked"
QT_MOC_LITERAL(2, 39, 0), // ""
QT_MOC_LITERAL(3, 40, 16), // "QListWidgetItem*"
QT_MOC_LITERAL(4, 57, 12), // "gPathClicked"
QT_MOC_LITERAL(5, 70, 20) // "directoryViewRefresh"

    },
    "FileBrowser\0directoryViewDoubleClicked\0"
    "\0QListWidgetItem*\0gPathClicked\0"
...
void FileBrowser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->directoryViewDoubleClicked((*reinterpret_cast< QListWidgetItem*(*)>(_a[1]))); break;
        case 1: _t->gPathClicked((*reinterpret_cast< QListWidgetItem*(*)>(_a[1]))); break;
        case 2: _t->directoryViewRefresh(); break;
        default: ;
        }
    }
}
